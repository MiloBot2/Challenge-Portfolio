<html>
    ...
    <body onload="load();">
        ...
        <div class="page-wrapper">
            <div class="container">
                <div class="cards">
                    <div style="align-self: flex-start;" class='card'>
                        <div class='card-header'>
                            <p style='color: #36302b; font-size: 135%;'>Coderen</p>
                        </div>
                    ...
                    <div style="align-self: flex-end;" class='card'>
                        <div class='card-header'>
                            <p style='color: #36302b; font-size: 135%;'>Gamen</p>
                        </div>
                        <div class='card-content'>
                            <img alt='Icon' width='90' height='90' src='https://i.pinimg.com/736x/e5/25/32/e52532453c211f34b4b2d22b595e97fd.jpg'>
                            <p><span>Naast het werken aan projecten vind ik het ook leuk om games zoals Minecraft te spelen.</span></p>
                        </div>
                    </div>
                    <div style="align-self: flex-start;" class='card'>
                        <div class='card-header'>
                            <p style='color: #36302b; font-size: 135%;'>Piano Spelen</p>
                        </div>
                        <div class='card-content'>
